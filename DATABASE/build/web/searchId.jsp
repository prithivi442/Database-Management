<%-- 
    Document   : searchId
    Created on : Jul 13, 2016, 10:23:45 AM
    Author     : Prithivi Raj
--%>
...
<%@include file="header.jsp" %>
        ...
        <title>Searched Entries!</title>
    </head>
    <body>

        <div class="masthead clearfix">
            <div class="inner">
                <h1 allign="center">Searched Entries!</h1>
            </div>
        </div>
        <p></p>
        <br><br>
        <div class="container">
                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="ViewEntries.jsp">ALL ENTRIES</a></li>
            ...
            <div class="container">
                ...
                <table class="table table-stripped table-bordered table-hover">
                    ...
                    <%
                        for (Student s : stdao.searchByName(request.getParameter("name"))) {
                    %>
                    <tr>
                        <td><%=s.getId()%></td>
                        <td><%=s.getFname()%></td>
